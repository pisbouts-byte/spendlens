...
export function Header({ onMenuToggle }: HeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-20 border-b border-gray-200 bg-white">
      ...
      {/* Header content */}
      <div className="flex h-14 items-center justify-between px-4 lg:h-16 lg:justify-end lg:px-6">
        {/* Mobile menu button */}
        <button
        ...
        {/* Mobile brand */}
        <span className="text-lg font-bold text-brand-600 lg:hidden">Budget Wisely</span>
